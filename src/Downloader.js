...
class{
  ...
  constructor(options) {
    this.intervalLengthSeconds = options.intervalLengthSeconds || NaN;;
    this.maxIntervalls = options.maxIntervallsPerDownload || NaN;;
    ...
    this.startDate.setDate(startDate.getDate() - options.historyLengthDays);
